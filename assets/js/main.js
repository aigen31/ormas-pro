...
/* harmony import */ var _js_block_news__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./js/block-news */ "./src/js/block-news.js");
/* harmony import */ var _js_block_party__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./js/block-party */ "./src/js/block-party.js");
/* harmony import */ var _js_block_reviews__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./js/block-reviews */ "./src/js/block-reviews.js");
/* harmony import */ var _js_block_services__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./js/block-services */ "./src/js/block-services.js");
/* harmony import */ var _js_block_signup__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./js/block-signup */ "./src/js/block-signup.js");
/* harmony import */ var _js_block_useful__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./js/block-useful */ "./src/js/block-useful.js");
/* harmony import */ var _js_footer__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./js/footer */ "./src/js/footer.js");
/* harmony import */ var _js_consultation__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./js/consultation */ "./src/js/consultation.js");
/* harmony import */ var _js_certificates__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./js/certificates */ "./src/js/certificates.js");
/* harmony import */ var _js_sidebar__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./js/sidebar */ "./src/js/sidebar.js");
/* harmony import */ var _js_sidebar__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_js_sidebar__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _js_page_services__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./js/page-services */ "./src/js/page-services.js");
/* harmony import */ var _js_materials__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./js/materials */ "./src/js/materials.js");
/* harmony import */ var _js_neuropsychology__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./js/neuropsychology */ "./src/js/neuropsychology.js");
/* harmony import */ var _js_psychological_support__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./js/psychological-support */ "./src/js/psychological-support.js");
...
if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(".post__list")[0]) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".post__list").not('.slick-initialized').slick({
    infinite: true,
    slidesToShow: 3,
    slidesToScroll: 1,
    arrows: true,
    dots: true,
    prevArrow: document.querySelector('.news .slick-prev'),
    nextArrow: document.querySelector('.news .slick-next'),
    responsive: [{
      breakpoint: 768,
      settings: {
        slidesToShow: 2,
...
if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(".news-slider")[0]) {
...
if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.party__list')[0]) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.party__list').not('.slick-initialized').slick({
    infinite: true,
    slidesToShow: 1,
    slidesToScroll: 1,
    centerMode: true,
...
if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.party__list-item-text-more')[0]) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.party__list-item-text-more').on('click', function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.party__poopup:nth-child(' + jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('number') + ')').removeClass('hidden');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).mouseup(function (e) {
      var div = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.party__poopup');
...
if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.neuropsychology-slider__list')[0]) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.neuropsychology-slider__list').not('.slick-initialized').slick({
    infinite: false,
    slidesToShow: 3,
    slidesToScroll: 1,
    centerMode: false,
...
if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(".reviews__list")[0]) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".reviews__list").slick({
    infinite: true,
    slidesToShow: 3,
    slidesToScroll: 1,
    arrows: true,
...
if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.image-popup-vertical-fit')[0]) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.image-popup-vertical-fit').magnificPopup({
    type: 'image',
...
function eyeIconClick() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.icon__eye').click(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).hide();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).prev().prev().hide();
  });
}

eyeIconClick();
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.reviews__list').on('breakpoint', function () {
  eyeIconClick();
});

/***/ }),

/***/ "./src/js/block-services.js":
/*!**********************************!*\
  !*** ./src/js/block-services.js ***!
  \**********************************/
/*! no exports provided */
...
var themePath = jquery__WEBPACK_IMPORTED_MODULE_0___default()("meta[property='themePath']").attr("content");
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.services__list-item-right-button').on('click', function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.services__poopup').removeClass('hidden');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.consultation-overlay').removeClass('hidden');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').css({
    "overflow": "hidden"
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.services__poopup').find('.poopup__inputs').show();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.services__poopup').find('.poopup__title').html('Записаться');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.services__poopup').find('.poopup__description').html('Оставьте ваши контактные данные, и наш администратор вскоре с Вами свяжется!');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.services-type').val(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('type'));
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.services-type-email_title').val(jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).data('email'));
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).click(function (e) {
    var div = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.services__poopup');
    var divsvg = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.services__poopup-svg');
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.services__inputs').submit(function (event) {
  var error = 0;
  var checked = false;
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.services__inputs .poopup__inputs-input').each(function () {
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.services__inputs .poopup__inputs-checkbox input').prop('checked') == false) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.services__inputs .poopup__inputs-checkbox').addClass('error');
    checked = false;
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.services__inputs .poopup__inputs-checkbox').removeClass('error');
    checked = true;
  }
  ...
  if (error == 0 && checked) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.services__inputs .poopup__inputs-checkbox input').prop('checked', false);
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
      type: 'POST',
      url: "".concat(themePath, "/request.php"),
      data: formData
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.services__poopup').find('.poopup__inputs').hide();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.services__poopup').find('.poopup__title').html('Спасибо за обращение!');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.services__poopup').find('.poopup__description').html('Наш администратор вскоре с Вами свяжется!');
  }

  event.preventDefault();
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.services__poopup-svg').click(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.services__poopup').addClass('hidden');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.consultation-overlay').addClass('hidden');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').css({
    "overflow": "auto"
  });
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.consultation-overlay').click(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.services__poopup').addClass('hidden');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.consultation-overlay').addClass('hidden');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').css({
    "overflow": "auto"
...
var themePath = jquery__WEBPACK_IMPORTED_MODULE_1___default()("meta[property='themePath']").attr("content");
jquery__WEBPACK_IMPORTED_MODULE_1___default()('.icon__close ').on('click', function () {
  jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).parent().addClass('hidden');
});
jquery__WEBPACK_IMPORTED_MODULE_1___default()('.signup__poopup-svg').click(function () {
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('.signup__poopup').addClass('hidden');
});

if (document.getElementById('phone-mask1')) {
  var phoneMask1 = Object(imask__WEBPACK_IMPORTED_MODULE_0__["default"])(document.getElementById('phone-mask1'), {
    mask: '+{7}(000)000-00-00'
  });
}

if (document.getElementById('phone-mask2')) {
  var phoneMask2 = Object(imask__WEBPACK_IMPORTED_MODULE_0__["default"])(document.getElementById('phone-mask2'), {
    mask: '+{7}(000)000-00-00'
  });
}

if (document.getElementById('phone-mask3')) {
  var phoneMask3 = Object(imask__WEBPACK_IMPORTED_MODULE_0__["default"])(document.getElementById('phone-mask3'), {
    mask: '+{7}(000)000-00-00'
  });
}

jquery__WEBPACK_IMPORTED_MODULE_1___default()('.signup__inputs').submit(function (event) {
  var error = 0;
  var checked = false;
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('.signup__inputs .signup__inputs-input').each(function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).val().length == 0) {
      jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).addClass('error');
      error++;
    } else {
      jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).removeClass('error');
    }
  });

  if (jquery__WEBPACK_IMPORTED_MODULE_1___default()('#signupCheckbox').prop('checked') == false) {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.signup__inputs-checkbox').addClass('error');
    checked = false;
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.signup__inputs-checkbox').removeClass('error');
    checked = true;
  }

  if (error == 0 && checked) {
    var formData = jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).serialize();
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.signup__inputs .signup__inputs-input').each(function () {
      jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).val('');
    });
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.signup__inputs-checkbox input').prop('checked', false);
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.signup__poopup').removeClass('hidden');
  }

  event.preventDefault();
  jquery__WEBPACK_IMPORTED_MODULE_1___default()(document).click(function (e) {
    var div = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.signup__poopup');
    var divsvg = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.signup__poopup-svg');
...
var themePath = jquery__WEBPACK_IMPORTED_MODULE_0___default()("meta[property='themePath']").attr("content");
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.useful-main-form').submit(function (event) {
  var formData = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).serialize();

  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('input').val().length == 0) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('input').addClass('error');
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('input').removeClass('error');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('input').val('');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.useful__right-button--more').text('Мы отправим Вам материалы в ближайшее время!');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.useful__right-button--more').prop('disabled', true);
    setTimeout(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.useful__right-button--more').text('Скачать');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.useful__right-button--more').prop('disabled', false);
    }, 5000); // console.log( formData)
...
if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(".certificates")[0]) {
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(".certificates__list")[0]) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(".certificates__list").slick({
      infinite: true,
      slidesToShow: 3,
      slidesToScroll: 1,
      arrows: true,
...
function eyeIconClick() {
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.icon__eye-second')[0]) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.icon__eye-second').click(function () {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).hide();
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).prev().prev().hide();
    });
  }
...
if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.certificates__list')[0]) {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.certificates__list').on('breakpoint', function () {
    eyeIconClick();
  });
}
...
var themePath = jquery__WEBPACK_IMPORTED_MODULE_0___default()("meta[property='themePath']").attr("content");
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.poopup-consultation__close').click(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.poopup-consultation__poopup').addClass('consultation-hide');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.consultation__inputs').removeClass('consultation-hide');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.consultation__text').removeClass('consultation-hide');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.greeting').removeClass('active');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.container').removeClass('active');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.consultation').removeClass('active');
});

if (document.getElementById('phone-mask1')) {
  var phoneMask1 = Object(imask__WEBPACK_IMPORTED_MODULE_1__["default"])(document.getElementById('phone-mask1'), {
    mask: '+{7}(000)000-00-00'
  });
}

if (document.querySelector('.phone-mask-service')) {
  var phoneMask1 = Object(imask__WEBPACK_IMPORTED_MODULE_1__["default"])(document.querySelector('.phone-mask-service'), {
    mask: '+{7}(000)000-00-00'
  });
}

if (document.getElementById('phone-mask2')) {
  var phoneMask2 = Object(imask__WEBPACK_IMPORTED_MODULE_1__["default"])(document.getElementById('phone-mask2'), {
    mask: '+{7}(000)000-00-00'
  });
}

if (document.getElementById('phone-mask3')) {
  var phoneMask3 = Object(imask__WEBPACK_IMPORTED_MODULE_1__["default"])(document.getElementById('phone-mask3'), {
    mask: '+{7}(000)000-00-00'
  });
}

jquery__WEBPACK_IMPORTED_MODULE_0___default()('.consultation__inputs').submit(function (event) {
  var error = 0;
  var checked = false;
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.consultation__inputs .consultation__inputs-input').each(function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val().length == 0) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass('error');
      error++;
    } else {
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.signup__inputs-checkbox input').prop('checked') == false) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.signup__inputs-checkbox').addClass('error');
    checked = false;
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.signup__inputs-checkbox').removeClass('error');
    checked = true;
  }
  ...
  if (error == 0 && checked) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.signup__inputs-checkbox input').prop('checked', false); // console.log( formData)
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.poopup-consultation__poopup').removeClass('consultation-hide');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.consultation__inputs').addClass('consultation-hide');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.consultation__text').addClass('consultation-hide');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.greeting').addClass('active');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.container').addClass('active');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.consultation').addClass('active');
  }
...
var themePath = jquery__WEBPACK_IMPORTED_MODULE_1___default()("meta[property='themePath']").attr("content");
jquery__WEBPACK_IMPORTED_MODULE_1___default()('.footer .footer__popup-svg').click(function () {
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('.footer .footer__popup').addClass('hidden');
});
jquery__WEBPACK_IMPORTED_MODULE_1___default()('.footer__top-line-column-inputs').submit(function (event) {
  var error = 0;
  var checked = false;

  if (jquery__WEBPACK_IMPORTED_MODULE_1___default()('.footer .footer__top-line-column-inputs-textarea').val().length == 0) {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.footer .footer__top-line-column-inputs-textarea').addClass('error');
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.footer .footer__top-line-column-inputs-textarea').removeClass('error');
  }

  jquery__WEBPACK_IMPORTED_MODULE_1___default()('.footer .footer__top-line-column-inputs-input').each(function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).val().length == 0) {
      jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).addClass('error');
      error++;
    } else {
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_1___default()('.footer .footer__top-line-column-inputs-checkbox input').prop('checked') == false) {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.footer .footer__top-line-column-inputs-checkbox').addClass('error');
    checked = false;
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.footer .footer__top-line-column-inputs-checkbox').removeClass('error');
    checked = true;
  }
  ...
  if (error == 0 && checked) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.footer .footer__top-line-column-inputs-textarea').val('');
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.footer .footer__top-line-column-inputs-checkbox input').prop('checked', false);
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.footer .footer__popup').removeClass('hidden'); // console.log( formData)
  ...
  event.preventDefault();
  jquery__WEBPACK_IMPORTED_MODULE_1___default()(document).click(function (e) {
    var div = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.footer .footer__popup');
    var divsvg = jquery__WEBPACK_IMPORTED_MODULE_1___default()('.footer .footer__popup-svg');
...
//   var map = new maps.Map(document.querySelector('.ymap'), {
//     center: [55.697975, 37.505274],
//     zoom: 16,
//     controls: []
//   });
...
//     geometry: {
//       type: "Point",
//       coordinates: [55.697975, 37.505274]
//     },
//     // Свойства.
//     properties: {
//       // Контент метки.
//       hintContent: 'Мичуринский проспект д. 19, корпус 1'
//     }
//   }, {
//     // Опции.
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__burger').click(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__burger-poopup').addClass('active');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__separate').addClass('active');
});
var defaultNavigationHtml = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__nav-burger').html();
var prevNavigationListHtml;

var allNavigationItems = function allNavigationItems() {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__burger-poopup a').click(function (e) {
    if (e.target.classList.contains('button-back') || e.target.classList.contains('button-back-svg')) {
      e.preventDefault();

      if (e.target.innerText == 'Наши услуги') {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__nav-burger').html(defaultNavigationHtml);
      } else {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__nav-burger').html(prevNavigationListHtml);
      }
    ...
    var nextNavigationListHtml = '';

    if (!firstElementList) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__burger-poopup').removeClass('active');
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__separate').removeClass('active');
      return;
    }
    ...
    prevNavigationListHtml = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__nav-burger').html();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__nav-burger').html(nextNavigationListHtml);
    allNavigationItems();
  });
};

allNavigationItems();
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__burger-poopup .icon__close').on('click', function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__burger-poopup').toggleClass('active');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__separate').toggleClass('active');
});
var headerNode = jquery__WEBPACK_IMPORTED_MODULE_0___default()('#header');
var headerNodeHeight = headerNode.height();
jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scroll(function () {
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop() > headerNodeHeight) {
    headerNode.addClass('active');
  } else {
    headerNode.removeClass('active');
  }
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.close-btn').click(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__burger-poopup').removeClass('active');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.header__separate').removeClass('active');
});
...
if (listNavigationItems) {
  listNavigationItems.forEach(function (item) {
    item.addEventListener('click', function (e) {
      ...
      if ((_e$target$href = e.target.href) === null || _e$target$href === void 0 ? void 0 : _e$target$href.match('none')) {
        e.preventDefault();
        return;
      }
    });
      ...
      if (!subList && link.innerText != 'Наши услуги') {
        ...
        if (allItems) {
          allItems.forEach(function (elem) {
            ...
            subMenu === null || subMenu === void 0 ? void 0 : subMenu.classList.remove('active');
            linkMenu === null || linkMenu === void 0 ? void 0 : linkMenu.classList.remove('active');
          });
        }
      }
    });
  ...
  var links = headerNav === null || headerNav === void 0 ? void 0 : headerNav.querySelectorAll('a');
  document.addEventListener('mouseover', function (ev) {
    if (!headerNav.contains(ev.target)) {
      subList === null || subList === void 0 ? void 0 : subList.classList.remove('active');
  ...
  forms.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      ...
      if (error == 0 && checked) {
        ...
        var _inputs = form.querySelectorAll('.useful__right-input');
        ...
        var _checkbox = form.querySelector('.useful__checkbox');

        _checkbox.checked = false;

        var _visibleCheckbox = form.querySelector('.site-checkbox__checkbox');

        _visibleCheckbox.classList.remove('error');
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.materials-form__item .footer__top-line-column-inputs-material').submit(function (event) {
  var error = 0;
  var checked = false;

  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.materials-form__item .footer__top-line-column-inputs-material .footer__top-line-column-inputs-textarea').val().length == 0) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.materials-form__item .footer__top-line-column-inputs-material .footer__top-line-column-inputs-textarea').addClass('error');
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.materials-form__item .footer__top-line-column-inputs-material .footer__top-line-column-inputs-textarea').removeClass('error');
  }

  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.materials-form__item .footer__top-line-column-inputs-material .footer__top-line-column-inputs-input').each(function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val().length == 0) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass('error');
      error++;
    } else {
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.materials-form__item .footer__top-line-column-inputs-material .footer__top-line-column-inputs-checkbox input').prop('checked') == false) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.materials-form__item .footer__top-line-column-inputs-material .footer__top-line-column-inputs-checkbox').addClass('error');
    checked = false;
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.materials-form__item .footer__top-line-column-inputs-material .footer__top-line-column-inputs-checkbox').removeClass('error');
    checked = true;
  }
  ...
  if (error == 0 && checked) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.materials-form__item .footer__top-line-column-inputs-material .footer__top-line-column-inputs-textarea').val('');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.materials-form__item .footer__top-line-column-inputs-material .footer__top-line-column-inputs-checkbox input').prop('checked', false);
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.materials-form__item .footer__top-line-column-inputs-material .footer__popup').removeClass('hidden'); // console.log( formData)
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
      ...
      jquery__WEBPACK_IMPORTED_MODULE_0___default()('.materials-form__item .footer__popup').removeClass('hidden');
      setTimeout(function () {
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.materials-form__item .footer__popup').addClass('hidden');
      }, 5000);
    });
  }
...
var themePath = jquery__WEBPACK_IMPORTED_MODULE_0___default()("meta[property='themePath']").attr("content");
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support__block-button').on('click', function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-popup').removeClass('hidden');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.consultation-overlay').removeClass('hidden');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-popup .poopup__inputs-input').removeClass('error');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-popup .site-checkbox').removeClass('error');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').css({
    overflow: 'hidden'
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-popup').find('.poopup__inputs').show();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-popup').find('.poopup__title').html('Записаться');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-popup').find('.poopup__description').html('Оставьте ваши контактные данные, и наш администратор вскоре с Вами свяжется!');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).click(function (e) {
    var div = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-popup');
    var divsvg = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-popup-svg');
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.how-work__button').on('click', function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.how-work__poopup').removeClass('hidden');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.consultation-overlay').removeClass('hidden');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.how-work__poopup .poopup__inputs-input').removeClass('error');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.how-work__poopup .site-checkbox').removeClass('error');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').css({
    overflow: 'hidden'
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.how-work__poopup').find('.poopup__inputs').show();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.how-work__poopup').find('.poopup__title').html('Записаться');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.how-work__poopup').find('.poopup__description').html('Оставьте ваши контактные данные, и наш администратор вскоре с Вами свяжется!');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).click(function (e) {
    var div = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.how-work__poopup');
    var divsvg = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.how-work__poopup-svg');
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.how-work__inputs').submit(function (event) {
  var error = 0;
  var checked = false;
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.how-work__inputs .poopup__inputs-input').each(function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val().length == 0) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass('error');
      error++;
    } else {
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.how-work__inputs .poopup__inputs-checkbox input').prop('checked') == false) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.how-work__inputs .poopup__inputs-checkbox').addClass('error');
    checked = false;
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.how-work__inputs .poopup__inputs-checkbox').removeClass('error');
    checked = true;
  }
  ...
  if (error == 0 && checked) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.how-work__inputs .poopup__inputs-checkbox input').prop('checked', false);
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
      type: 'POST',
      url: "".concat(themePath, "/request.php"),
      data: formData
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.how-work__poopup').find('.poopup__inputs').hide();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.how-work__poopup').find('.poopup__title').html('Спасибо за обращение!');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.how-work__poopup').find('.poopup__description').html('Наш администратор вскоре с Вами свяжется!');
  }

  event.preventDefault();
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.how-work__poopup-svg').click(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.how-work__poopup').addClass('hidden');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.consultation-overlay').addClass('hidden');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').css({
    overflow: 'auto'
  });
...
var themePath = jquery__WEBPACK_IMPORTED_MODULE_0___default()("meta[property='themePath']").attr("content");
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.servise-form__close').click(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.servise-form__send-form').removeClass('show');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.page-service__inputs-checkbox').removeClass('error');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.page-service__inputs .page-service__inputs-input').each(function () {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).removeClass('error');
  });
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.page-service__inputs').submit(function (event) {
  var error = 0;
  var checked = false;
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.page-service__inputs .page-service__inputs-input').each(function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val().length == 0) {
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.page-service__inputs-checkbox input').prop('checked') == false) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.page-service__inputs-checkbox').addClass('error');
    checked = false;
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.page-service__inputs-checkbox').removeClass('error');
    checked = true;
  ...
  if (error == 0 && checked) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.page-service__inputs-checkbox input').prop('checked', false); // console.log( formData)

    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.servise-form__send-form').addClass('show');
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
      type: 'POST',
      url: "".concat(themePath, "/request.php"),
      data: formData
...
/***/ "./src/js/psychological-support.js":
/*!*****************************************!*\
  !*** ./src/js/psychological-support.js ***!
  \*****************************************/
/*! no exports provided */
...
var themePath = jquery__WEBPACK_IMPORTED_MODULE_0___default()("meta[property='themePath']").attr("content");
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.frequent-questions__button').on('click', function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.frequent-questions__poopup').removeClass('hidden');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.consultation-overlay').removeClass('hidden');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.frequent-questions__poopup .poopup__inputs-input').removeClass('error');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.frequent-questions__poopup .site-checkbox').removeClass('error');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').css({
    overflow: 'hidden'
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.frequent-questions__poopup').find('.poopup__inputs').show();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.frequent-questions__poopup').find('.poopup__title').html('Остались вопросы?');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.frequent-questions__poopup').find('.poopup__description').html('Оставьте ваши контактные данные, и наш администратор вскоре с Вами свяжется!');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).click(function (e) {
    var div = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.frequent-questions__poopup');
    var divsvg = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.frequent-questions__poopup-svg');
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support__inputs').submit(function (event) {
  var error = 0;
  var checked = false;
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support__inputs .poopup__inputs-input').each(function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val().length == 0) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass('error');
      error++;
    } else {
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support__inputs .poopup__inputs-checkbox input').prop('checked') == false) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support__inputs .poopup__inputs-checkbox').addClass('error');
    checked = false;
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support__inputs .poopup__inputs-checkbox').removeClass('error');
    checked = true;
  }
  ...
  if (error == 0 && checked) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support__inputs .poopup__inputs-checkbox input').prop('checked', false);
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
      type: 'POST',
      url: "".concat(themePath, "/request.php"),
      data: formData
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-popup').find('.poopup__inputs').hide();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-popup').find('.poopup__title').html('Спасибо за обращение!');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-popup').find('.poopup__description').html('Наш администратор вскоре с Вами свяжется!');
  }

  event.preventDefault();
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-popup-svg').click(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-popup').addClass('hidden');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.consultation-overlay').addClass('hidden');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').css({
    overflow: 'auto'
  });
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ps-services-and-prices-btn').on('click', function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ps-services-and-prices-popup').removeClass('hidden');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.consultation-overlay').removeClass('hidden');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ps-services-and-prices-popup .poopup__inputs-input').removeClass('error');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ps-services-and-prices-popup .site-checkbox').removeClass('error');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').css({
    overflow: 'hidden'
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ps-services-and-prices-popup').find('.poopup__inputs').show();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ps-services-and-prices-popup').find('.poopup__title').html('Записаться');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ps-services-and-prices-popup').find('.poopup__description').html('Оставьте ваши контактные данные, и наш администратор вскоре с Вами свяжется!');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).click(function (e) {
    var div = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ps-services-and-prices-popup');
    var divsvg = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ps-services-and-prices-svg');
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ps-services-and-prices-inputs').submit(function (event) {
  var error = 0;
  var checked = false;
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ps-services-and-prices-inputs .poopup__inputs-input').each(function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val().length == 0) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass('error');
      error++;
    } else {
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ps-services-and-prices-inputs .poopup__inputs-checkbox input').prop('checked') == false) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ps-services-and-prices-inputs .poopup__inputs-checkbox').addClass('error');
    checked = false;
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ps-services-and-prices-inputs .poopup__inputs-checkbox').removeClass('error');
    checked = true;
  }
  ...
  if (error == 0 && checked) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ps-services-and-prices-inputs .poopup__inputs-checkbox input').prop('checked', false);
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
      type: 'POST',
      url: "".concat(themePath, "/request.php"),
      data: formData
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ps-services-and-prices-popup').find('.poopup__inputs').hide();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ps-services-and-prices-popup').find('.poopup__title').html('Спасибо за обращение!');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ps-services-and-prices-popup').find('.poopup__description').html('Наш администратор вскоре с Вами свяжется!');
  }

  event.preventDefault();
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ps-services-and-prices-svg').click(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.ps-services-and-prices-popup').addClass('hidden');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.consultation-overlay').addClass('hidden');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').css({
    overflow: 'auto'
  });
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-how-work-button').on('click', function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-how-work-popup').removeClass('hidden');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.consultation-overlay').removeClass('hidden');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-how-work-popup .poopup__inputs-input').removeClass('error');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-how-work-popup .site-checkbox').removeClass('error');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').css({
    overflow: 'hidden'
  });
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-how-work-popup').find('.poopup__inputs').show();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-how-work-popup').find('.poopup__title').html('Записаться');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-how-work-popup').find('.poopup__description').html('Оставьте ваши контактные данные, и наш администратор вскоре с Вами свяжется!');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).click(function (e) {
    var div = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-how-work-popup');
    var divsvg = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-how-work-svg');
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-how-work-inputs').submit(function (event) {
  var error = 0;
  var checked = false;
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-how-work-inputs .poopup__inputs-input').each(function () {
    if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).val().length == 0) {
      jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).addClass('error');
      error++;
    } else {
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()('psychological-support-how-work-inputs .poopup__inputs-checkbox input').prop('checked') == false) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-how-work-inputs .poopup__inputs-checkbox').addClass('error');
    checked = false;
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-how-work-inputs .poopup__inputs-checkbox').removeClass('error');
    checked = true;
  }
  ...
  if (error == 0 && checked) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-how-work-inputs .poopup__inputs-checkbox input').prop('checked', false);
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.ajax({
      type: 'POST',
      url: "".concat(themePath, "/request.php"),
      data: formData
    });
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-how-work-popup').find('.poopup__inputs').hide();
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-how-work-popup').find('.poopup__title').html('Спасибо за обращение!');
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-how-work-popup').find('.poopup__description').html('Наш администратор вскоре с Вами свяжется!');
  }

  event.preventDefault();
});
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-how-work-svg').click(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.psychological-support-how-work-popup').addClass('hidden');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.consultation-overlay').addClass('hidden');
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').css({
    overflow: 'auto'
  });
...
if (animItems.length > 0) {
  var animOnScroll = function animOnScroll(params) {
    var _iterator = _createForOfIteratorHelper(animItems),
        _step;

    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var animItem = _step.value;
