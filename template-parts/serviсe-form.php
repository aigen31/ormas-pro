<section class="servise-form _anim-items" >
  ...
  <div class="servise-form__wrapper">
    ...
    <form action="" method="POST" class="site-inputs services__inputs page-service__inputs">
      ...
      <input type="text" placeholder="Ваш номер телефона" class="site-input page-service__inputs-input phone-mask-service" id="phone-mask3" name="phone">
      <input type="hidden" class="services-type" value="9" name="type">
      <div class="site-checkbox page-service__inputs-checkbox">
        <label>
          <input type="checkbox">
          <div class="site-checkbox__checkbox">
            <svg width="11" height="9" viewBox="0 0 11 9" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M1.41 3L4 5.58L9.59 0L11 1.41L4 8.41L0 4.41L1.41 3Z" fill="#fff" /></svg>
          </div>
