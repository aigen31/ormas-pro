...
<div class="consultation" id="consultation">
        <div class="container container-consultation">
            ...
            <div class="consultation__text">
                ...
                <div class="consultation__text-title consultation__text-title_hide">Нужна помощь? </div>
                ...
                <div class="consultation__text-description consultation__text-description_hide">
                    <p class="consultation__text-description-item">
                         Заполните заявку. Мы поможем разобраться и подобрать специалиста
                    </p>
